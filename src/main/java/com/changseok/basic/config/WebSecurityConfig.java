package com.changseok.basic.config;
...
import com.changseok.basic.filter.JwtAuthenticationFilter;
...
public class WebSecurityConfig {
    ...
    protected SecurityFilterChain configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
            ...
            // description: url 패턴에 따른 지정 (/user로 시작하는 모든 요청에 대하여 허용) //
            .antMatchers("/user/**").permitAll()
            // description: http method에 따른 지정 (모든 GET 요청에 대해서 적용) //

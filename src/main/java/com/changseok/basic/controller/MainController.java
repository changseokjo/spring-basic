package com.changseok.basic.controller;
...
public class MainController {
    ...
    // description: 값을 얻기 위한 요청 //
    // description: 데이터 입력 시 URL로 입력 //
    @GetMapping("")
    ...
    // description: 데이터를 수정하기 위한 요청 (일부만 수정) //
    // description: 데이터 입력 시 Body로 입력 //
    @PatchMapping("")
    ...
    // description: {변수명}로 표현 -> @PathVariable("변수명")으로 받음 //
    ...
    // description: @RequestParam("name1") -> name1에 대한 value1를 받아옴 //
